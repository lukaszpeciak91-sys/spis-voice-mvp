...
class BasicTokenProvider : TokenProvider {
    private val tokens: Map<String, Token> = mapOf(
        ...
        "jedenascie" to Token("11", TokenType.NUMBER, numberValue = 11),
        "jedenaście" to Token("11", TokenType.NUMBER, numberValue = 11),
        "dwanascie" to Token("12", TokenType.NUMBER, numberValue = 12),
        "dwanaście" to Token("12", TokenType.NUMBER, numberValue = 12),
        "trzynascie" to Token("13", TokenType.NUMBER, numberValue = 13),
        "trzynaście" to Token("13", TokenType.NUMBER, numberValue = 13),
        "czternascie" to Token("14", TokenType.NUMBER, numberValue = 14),
        "czternaście" to Token("14", TokenType.NUMBER, numberValue = 14),
        "pietnascie" to Token("15", TokenType.NUMBER, numberValue = 15),
        "piętnaście" to Token("15", TokenType.NUMBER, numberValue = 15),
